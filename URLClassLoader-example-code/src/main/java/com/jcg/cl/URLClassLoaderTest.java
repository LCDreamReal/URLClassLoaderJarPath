...
//		URL[] classLoaderUrls = new URL[]{new URL("file:///home/ashraf/Desktop/simple-bean-1.0.jar")};
		URL[] classLoaderUrls = new URL[]{new URL("file:E:/Study/URLClassLoader-example-code/java.net.URLClassLoader-example-code/simple-bean/target/simple-bean-1.0.jar")};
